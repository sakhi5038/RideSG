...
import 'package:flutter_application_ride_sg/BottomNavigationScreens/history_completed_activity.dart';
...
class CancelledActivity extends StatefulWidget {
  const CancelledActivity({super.key});

  @override
  State<CancelledActivity> createState() => _CancelledActivityState();
}

class _CancelledActivityState extends State<CancelledActivity> {
  @override
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.to(()=> CompletedActivity(), transition: Transition.noTransition);
                        },
                        child: Container(
