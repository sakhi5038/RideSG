...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new co.doneservices.callkeep.CallKeepPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_callkeep, co.doneservices.callkeep.CallKeepPlugin", e);
    }
    try {
    ...
    try {
      flutterEngine.getPlugins().add(new com.eopeter.fluttermapboxnavigation.FlutterMapboxNavigationPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_mapbox_navigation, com.eopeter.fluttermapboxnavigation.FlutterMapboxNavigationPlugin", e);
    }
    try {
